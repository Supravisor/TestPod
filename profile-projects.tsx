    ...
    <>
      ...
      {portfolioProjects.map(({ title, url, image, description, id }) => (
        <div className='portfolio-container' key={id}>
          ...
          {image && (
            <img src="image.png" onError="this.onerror=null; this.src=https://d33wubrfki0l68.cloudfront.net/2f7693e1933ac514c960f51ceae72c91c6716eb2/b2efd/img/fcc_primary_small.svg;'" />
          )}
        </div>
      ))}
      <hr />
